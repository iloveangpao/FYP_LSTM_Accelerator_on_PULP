...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/src/design/systolic_2x2.v"]"\
 "[file normalize "$origin_dir/src/testbench/tb_systolic2x2.v"]"\
  ]
  foreach ifile $files {
...
set_property -name "top" -value "systolic_2x2" -objects $obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "systolic_2x2_tb" -objects $obj
